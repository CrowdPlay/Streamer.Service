...
MediaService.prototype.createArtistDetailUrl = function (artistId) {
  var url = "http://api.7digital.com/1.2/artist/details";
...
MediaService.prototype.createReleaseDetailUrl = function (releaseId) {
  var url = "http://api.7digital.com/1.2/release/details";
...
MediaService.prototype.artistDetailRequest = function (artistId, callback) {
  var fullUrl = this.createArtistDetailUrl(artistId);
  ...
  return request.get(fullUrl, function (error, response, body) {
    ...
    parseString(body, function (err, result) {
      ...
      var artist = result.response.artist[0];
      ...
      callback(null, artistDetail);
    });
  });
};

MediaService.prototype.releaseDetailRequest = function (releaseId, callback) {
  var fullUrl = this.createReleaseDetailUrl(releaseId);
  ...
  return request.get(fullUrl, function (error, response, body) {
    ...
    parseString(body, function (err, result) {
      ...
      var release = result.response.release[0];
